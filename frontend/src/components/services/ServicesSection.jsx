      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-extrabold text-slate-900 tracking-tight">
            Nuestros 8 Pilares de Servicios
          </h2>
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
            Soluciones integrales de marketing en punto de venta, producción de eventos, desarrollo de módulos e infraestructura con cobertura a nivel nacional.
          </p>
        </div>

        {/* Grid de los 8 servicios en tarjetas claras de alto impacto */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="light-card rounded-3xl flex flex-col justify-between overflow-hidden group shine-hover hover:-translate-y-2 hover:shadow-xl hover:shadow-sky-100 transition-all duration-300"
              >
                <div>
                ...
                <div className="px-6 pb-6 pt-2 flex items-center justify-between gap-2 border-t border-slate-100 mt-2 bg-slate-50/50">
                  <button
                    ...
                    className="text-xs font-bold text-[#55A2DC] hover:text-[#3888c3] flex items-center gap-1.5 transition-colors cursor-pointer"
                  >
                    <Eye className="w-3.5 h-3.5" />
                    <span>Ver Fotos & Alcance</span>
                  </button>
